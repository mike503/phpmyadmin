...
// often on many hosts, this is useful
$cfg['PmaAbsoluteUri'] = 'https://' . $_SERVER['HTTP_HOST'] . '/somedir/';
...
$cfg['Servers'][$i]['socket']        = '/var/run/mysqld/mysqld.sock';          // Path to the socket - leave blank for default socket
...
$cfg['Servers'][$i]['history']       = '';          // table to store SQL history
                                                    ...
                                                    //     DEFAULT: 'pma_history'
$cfg['Servers'][$i]['verbose_check'] = FALSE;        // set to FALSE if you know that your pma_* tables
...
$cfg['LeftFrameDBTree']       = FALSE;    // turn the select-based light menu into a tree
$cfg['LeftFrameDBSeparator']  = '^^^';     // the separator to sub-tree the select-based light menu tree
$cfg['LeftFrameTableSeparator']= '^^^^';   // Which string will be used to generate table prefixes
                                         // to split/nest tables into multiple categories
$cfg['LeftFrameTableLevel']   = '1';     // How many sublevels should be displayed when splitting
                                         // up tables by the above Separator
$cfg['ShowTooltip']           = FALSE;    // display table comment as tooltip in left frame
...
$cfg['LightTabs']             = TRUE;  // use graphically less intense menu tabs
